...
<html>
	<head>
		<title>Clinique des Oasis - Ajouter un Spécialiste</title>
    	...
    	<table align="center" cellspacing="0" width="760" cellpadding="0" border="1">
			<tr>
				...
				<td width="620" valign=top>
					<table width="100%">
    						<th  colspan="2" align="left"><a href="../default.aspx">Accueil</a> > <a href="../SM.aspx">Services Médicaux > <a href="ListSpecialites.aspx">Spécialités</a> > <asp:HyperLink ID="Specialite" Runat=server /> > Ajouter un Spécialiste</th>
						<tr>
