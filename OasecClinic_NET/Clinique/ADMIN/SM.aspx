...
<html>
	<head>
		<title>Clinique des Oasis - Servies Médicaux</title>
    	...
    	<table align="center" cellspacing="0" width="760" cellpadding="0" border="1">
			<tr>
				...
				<td width="620" valign=top>
    				<table width="100%">
    					<th colspan="2" align=left><a href="default.aspx">Accueil</a> > Servies Médicaux</th>
						<tr>
							<td width="10"></td>
							<td>
								<br>
								<b>Servies Médicaux</b><hr>
								<table align=center width="80%">
									<tr>
										    <td><b><a href="SM/ListCentres.aspx?Centre_Type=H">Hôpitaux</a></b> (<asp:Label id="Hospital" Runat=server />)</td>
											<td><b><a href="SM/ListCentres.aspx?Centre_Type=C">Cliniques</a></b> (<asp:Label id="Clinic" Runat=server />)</td>
									</tr>
									<tr>
											<td><b><a href="SM/ListSpecialites.aspx">Spécialistes</a></b> (<asp:Label id="Specialist" Runat=server />)</td>
											<td><b><a href="SM/ListCentres.aspx?Centre_Type=P">Pharmacies</a></b> (<asp:Label id="Pharmacetical" Runat=server />)</td>
									</tr>
									<tr>
											<td><b><a href="SM/ListCentres.aspx?Centre_Type=M">Matériel Médical</a></b> (<asp:Label id="Material" Runat=server />)</td>
									</tr>
								</table>								
							</td>
						</tr>
