...
<html>
	<head>
		<title>Clinique des Oasis - Hall d'accueil</title>
    	...
    	<table align="center" cellspacing="0" width="760" cellpadding="0" border="1">
			<tr>
				...
				<td width="480" valign=top>
    				<table width="100%">
    						<th align=left colspan="2"><a href="Presentation.aspx">Présentation</a> > <a href="Departements.aspx">Départements</a> > Hall d'accueil</th>
						<tr>
							<td width=10></td>
							<td>
								<br>
								<p class="Details">		
									<table width="100%" cellspacing="10">
										<tr>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp; Un personnel attentif et compétent est chargé de fixer les 
												rendez-vous, orienter les patients et fournir les renseignements pratiques pour vous 
												aider à organiser votre déplacement et votre séjour éventuel dans la clinique.
											</td>
