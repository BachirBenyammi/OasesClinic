...
PADDING-LEFT: 3px
	...
	<div class="menuitems" url="news.php">Acualité</div>
	<div class="menuitems" url="specialites.php">Spécialités</div>
	<div class="menuitems" url="ListVisiteursStats.php.php">Stats. Visiteurs</div>
	<div class="menuitems" url="contacts.php">Contacts</div>
	<hr>
</div>
