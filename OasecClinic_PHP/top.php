		...
		<td colspan="2" align=right>
			<? 
				if (session_is_registered("account") && session_is_registered('password'))
					print "Bienvenue <b> ".$account."</b> <a class=link href='./admin/index.php'>Admin</a> | <a class=link href='./admin/logout.php' OnClick='javascript:return deconnect();'>[Déconnexion]</a> |";
			?>
