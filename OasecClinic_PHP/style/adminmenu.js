...
if (typeof(loc)=="undefined" || loc==""){
	...
	if (document.body){
		...
		var last = tt.indexOf("adminmenu.js\"");
		if (last>0){
...
document.write("<td><img src=\""+loc+"adminmenu_left.gif\" alt=\"\" width=\"9\" height=\"28\"></td>");
tr(false);
writeButton(loc+"","./../admin/index.php","adminmenu_b1",91,28,"Accueil","",0);
writeButton(loc+"","./../admin/news.php","adminmenu_b2",91,28,"Actualités","",0);
writeButton(loc+"","./../admin/specialites.php","adminmenu_b3",91,28,"Spécialités","",0);
writeButton(loc+"","./../admin/stats.php","adminmenu_b4",91,28,"Statistiques","",0);
writeButton(loc+"","./../admin/contacts.php","adminmenu_b5",91,28,"Contacts","",0);
tr(true);
document.write("<td><img src=\""+loc+"adminmenu_right.gif\" alt=\"\" width=\"15\" height=\"28\"></td>");
